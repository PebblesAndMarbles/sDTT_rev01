...
### B) APC-enriched HCCD output (1278 D1V only)
Primary file:
...
- APC join is targeted at 1278 D1V HCCD flow.
...
- 1278 pipeline can run APC join; 1280 pipeline is configured without APC join.
